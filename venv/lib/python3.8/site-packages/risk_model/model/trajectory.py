...
x5, y5, _ = get_straight_dubins([-0.9, -13], [-0.9, -2.5], np.pi/2, np.pi/2) 	# left
x14, y14, _ = get_dubins([-0.9, -2.5], [2.5, 0.9], np.pi/2, 0)					# left to down
x2, y2, _ = get_straight_dubins([2.5, 0.9], [13, 0.9], 0, 0)             		# down 

x_1, y_1 = np.hstack((x5, x14, x2)), np.hstack((y5, y14, y2))
x_2, y_2 = np.hstack((x1, x9, x6)), np.hstack((y1, y9, y6))
waypoints_1 = arr_to_point(x_1, y_1)
waypoints_2 = arr_to_point(x_2, y_2)
