...
from matplotlib.pyplot import clf, gcf, pause, plot, scatter
...
def animate(ego_trajectory: UncertainTrajectory, other_trajectories: list[UncertainTrajectory]) -> None:
    ...
    fig = figure(111, figsize=(20, 30))
    axes = fig.gca()

    # for path in paths:
    #     plot([point[0] for point in path], [point[1] for point in path], color="black", alpha=0.1)
    ...
    #     scatter(trajectory.positions[0][0], trajectory.positions[0][1], color="black", zorder=5)

    #     if trajectory.id in max_risk_ids:
    #         plot([ego_trajectory.positions[0][0], trajectory.positions[0][0]],
    #              [ego_trajectory.positions[0][1], trajectory.positions[0][1]], color="blue", zorder=5)
